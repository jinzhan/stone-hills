    ...
    public static function getCountUrl(){
        ...
        if(self::isSample($sampleRate) && $fid){           
            ...
            if (count($first_screen) >0 || count($other) >0 ) {
                ...
                $code .= '(new Image()).src="https://gsp0.baidu.com/5aAHeD3nKhI2p27j8IqW0jdnxx1xbK/tb/pms/img/st.gif?pid=242&v=' . self::$VER . '&fs=' . $fsStr . "&otherStr=" . $otherStr .  "&page=" . $pageName  . '&sid=' . $timeStamp . '&hash=<STATIC_HASH>' . '&fid=' . $fid . '";';
